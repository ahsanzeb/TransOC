...
{ \large \color{blue}
TODO:\\
$\Rightarrow$ 1. p/n-doping: coulomb energy tend to neutralise the system, and strong coupling tend to deplete the carriers. $\Rightarrow$ If n/p type doping, these two effects can compete against each other; when no doping, they cooperate.\\
$\Rightarrow$ 2. e/h traps: think about electron traps, strong coupling will mix homo and lumo and electron traps will have chance to leak down to empty homo! effectively, strong coupling will suppress effect of traps, which can be a huge advantage to some devices!


For either 1/2, a single level for a donor/acceptor or trap can be included. in the code, similar to contacts, with the condition that now type of hops possible will depend on the occupancy these levels along with that of nns.
}
